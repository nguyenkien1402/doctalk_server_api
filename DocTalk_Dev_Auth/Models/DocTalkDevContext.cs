...
namespace DocTalk_Dev_Auth.Models
{
    public partial class DocTalkDevContext : DbContext
    {
        ...
        public virtual DbSet<DoctorDocuments> DoctorDocuments { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Doctor>(entity =>
            {
                ...
                entity.Property(e => e.ClinicName).HasMaxLength(450);

                entity.Property(e => e.ClinicState).HasMaxLength(10);

                entity.Property(e => e.ClinicSuburb).HasMaxLength(100);

                entity.Property(e => e.ConfirmDoctor).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<DoctorDocuments>(entity =>
            {
                entity.Property(e => e.DocumentConfirm).HasDefaultValueSql("((0))");
                ...
                entity.HasOne(d => d.Doctor)
                    ...
                    .HasForeignKey(d => d.DoctorId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__DoctorDoc__Docto__76969D2E");
            });
